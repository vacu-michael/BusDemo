...
public record ApplicationSubmitted(Guid CorrelationId, int ApplicationId) : CorrelatedBy<Guid>;

// ValidateName Events
public record ValidateNameSucceeded(Guid CorrelationId) : CorrelatedBy<Guid>;
public record ValidateNameOverrideRequested(Guid CorrelationId) : CorrelatedBy<Guid>;
...
// Add a single retry event for all commands
public record RetryRequested(Guid CorrelationId) : CorrelatedBy<Guid>;
